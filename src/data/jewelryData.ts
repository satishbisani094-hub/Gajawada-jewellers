...
export const allProducts: Product[] = [
  ...
  // Bridal Collections
  {
    ...
    // We can use the custom generated hero banner image here!
    imageUrl: 'jewelry_hero_banner', // Special placeholder we resolve dynamically to the actual generated image
    purity: '22K Gold (91.6% BIS Hallmarked)',
  ...
  // Diamond Jewelry
  {
    ...
    category: 'rings', // Also matches rings context
    ...
    // We will use our custom generated diamond ring image here!
    imageUrl: 'jewelry_diamond_ring', // Special placeholder resolved dynamically
